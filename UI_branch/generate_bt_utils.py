...
def mysql_connect():
    ...
    try:
        ...
        print "<p>MySql Operation Failed because %s</p>" %(str(e))
        sys.stdout.flush()
        exit(0)
...
def insert_into_database(issue_key, issue_status, task_id, total, title, last_line, created_date,issue_signal,function_list, **kwargs):
    ...
    issue_signal = issue_signal.strip()
    if conn:
        cursor = conn.cursor()
        try:
            ...
            print "<p>MySql Database Update Failed because %s hence please send details of this error to santosh@avinetworks.com</p>" %(str(e))
            sys.stdout.flush()
            exit(0)
...
#    print "Content-Type: text/html\r\n"
    html =  """ 
              ...
              <table style="width:100%">
               <caption><b>The Stack Trace Matches an Existing Bug whose Details are Shown below:</b></caption>
                <tr>
                    <th>Core File</th>
                        <th>Crash Function</th> 
                            <th>Matching JIRA ID</th>
                            <th>Status</th>
                              </tr> """
    print html                              
    print "<tr>"
...
#    print "Content-Type: text/plain\r\n"
    html =  """ 
              ...
              <div>
              <table style="width:100%">
               <caption><b>The Stack Trace Did not match any Existing Bug hence a New Bug is created with the BUG ID as shown below:</b></caption>
                <tr>
                    <th>Core File</th>
                        <th>Crash Function</th> 
                            <th>New JIRA ID</th>
